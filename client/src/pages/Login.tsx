...
import { signInWithProvider, type AuthProvider } from "@/lib/supabase";
            ...
            <CardFooter className="flex flex-col gap-4 pt-0">
              <div className="relative w-full">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-slate-800 px-2 text-slate-500">Ou continue com</span>
                </div>
              </div>
              ...
              <p className="text-xs text-slate-500 text-center">
                Configure os provedores OAuth no painel do Supabase
              </p>
            </CardFooter>
          </Tabs>
        </Card>
